# Angular 14 & React 18 Prototypes
...
* Featuring [**Angular 14.1.3**](https://github.com/angular/angular/releases) & [**Angular CLI 14.1.3**](https://github.com/angular/angular-cli/releases/)
